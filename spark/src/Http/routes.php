...
$router->group(['middleware' => 'web'], function ($router) {
    ...
    // API Settings
    $router->get('/settings/pomoking-api/tokens', 'Settings\API\TokenController@all');
    $router->post('/settings/pomoking-api/token', 'Settings\API\TokenController@store');
    $router->put('/settings/pomoking-api/token/{token_id}', 'Settings\API\TokenController@update');
    $router->get('/settings/pomoking-api/token/abilities', 'Settings\API\TokenAbilitiesController@all');
    $router->delete('/settings/pomoking-api/token/{token_id}', 'Settings\API\TokenController@destroy');
